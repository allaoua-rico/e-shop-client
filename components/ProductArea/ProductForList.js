...
export default function ProductForList({ id, title, image, price, rating,desc }) {
      ...
      <div className="relative w-full col-span-2">
       ...
       group-hover:-translate-y-10 opacity-0 z-10 group-hover:opacity-100"
        ...
        <div className="py-0 px-8 flex flex-col gap-y-4 z-10 bg-white ">
          ...
          <p className=" my-1  sm:text-base text-lg">{desc ? desc : 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit saepe quo praesentium enim ipsum quod. Dolores numquam provident rem iste dolore labore vel aperiam reiciendis delectus, aliquam fugiat quo asperiores!'} </p>
